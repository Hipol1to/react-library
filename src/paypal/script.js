...
export function paypalInitialize() {
  ...
  url_to_head(
    ...
    .then(() => {
      ...
      let alerts = document.getElementById("alerts");
      let paypal_buttons = window.paypal.Buttons({
        ...
        onApprove: function (data, actions) {
          ...
          return fetch("http://localhost:3000/complete_order", {
            ...
            .catch((error) => {
              console.log(error);
              alerts.innerHTML = `<div class="ms-alert ms-action2 ms-small"><span class="ms-close"></span><p>Lo sentimos, ha ocurrido un error</p>  </div>`;
            });
        },

        onCancel: function (data) {
          alerts.innerHTML = `<div class="ms-alert ms-action2 ms-small"><span class="ms-close"></span><p>Tu compra fué cancelada</p>  </div>`;
        },
